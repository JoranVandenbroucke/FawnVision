...
{
BALBINO_CONSTEXPR_SINCE_CXX11 auto CheckVkResult(const VkResult err, const std::string_view failMessage = "", const VkResult exclusions = VK_SUCCESS, const std::source_location& location = std::source_location::current()) -> bool
{
