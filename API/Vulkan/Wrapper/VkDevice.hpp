...
struct SPhysicalDeviceInfo final
{
    ...
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX11 auto SPhysicalDeviceInfo::GetMaxUsableSampleCount() const BALBINO_NOEXCEPT_SINCE_CXX11->VkSampleCountFlagBits
    {
...
struct SQueueFamily
{
    ...
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX11 auto SQueueFamily::IsComplete() const BALBINO_NOEXCEPT_SINCE_CXX11->bool
    {
...
{
  public:
    BALBINO_CONSTEXPR_SINCE_CXX11 BALBINO_EXPLICIT_SINCE_CXX11 CVkDevice::CVkDevice(SPhysicalDeviceInfo deviceInfo)
        : m_deviceInfo{std::move(deviceInfo)}
    {
    }
    BALBINO_CONSTEXPR_SINCE_CXX11 CVkDevice::~CVkDevice()
    {
    ...
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX23 void CVkDevice::WaitIdle() const BALBINO_NOEXCEPT_SINCE_CXX11
    {
        vkDeviceWaitIdle(m_device);
    }
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX11 auto CVkDevice::Initialize(const std::vector<const char*>& layersToEnable, const std::vector<const char*>& extensionsToEnable, const SQueueFamily& queueFamily) BALBINO_NOEXCEPT_SINCE_CXX11->int32_t
    {
    ...
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX11 auto CVkDevice::Device() const BALBINO_NOEXCEPT_SINCE_CXX11->const VkDevice&
    {
        return m_device;
    }
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX11 auto CVkDevice::PhysicalDeviceInfo() const BALBINO_NOEXCEPT_SINCE_CXX11->const SPhysicalDeviceInfo&
    {
        return m_deviceInfo;
    }
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX11 auto CVkDevice::DescriptorPool() const BALBINO_NOEXCEPT_SINCE_CXX11->VkDescriptorPool
    {
