...
public:
    ...
    BALBINO_NODISCARD_SINCE_CXX17 auto Initialize(CVkSwapChain* pSwapChain, const uint32_t queueFamilyIndex) BALBINO_NOEXCEPT_SINCE_CXX11 -> int32_t
    {
        ...
        vkCmdBeginRenderingKHR = std::bit_cast<PFN_vkCmdBeginRenderingKHR>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdBeginRenderingKHR"));
        vkCmdEndRenderingKHR = std::bit_cast<PFN_vkCmdEndRenderingKHR>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdEndRenderingKHR"));

        vkCmdSetColorBlendEnableEXT = std::bit_cast<PFN_vkCmdSetColorBlendEnableEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetColorBlendEnableEXT"));
        vkCmdSetColorWriteMaskEXT = std::bit_cast<PFN_vkCmdSetColorWriteMaskEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetColorWriteMaskEXT"));
        vkCmdSetCullModeEXT = std::bit_cast<PFN_vkCmdSetCullModeEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetCullModeEXT"));
        vkCmdSetDepthBiasEnableEXT = std::bit_cast<PFN_vkCmdSetDepthBiasEnableEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetDepthBiasEnableEXT"));
        vkCmdSetDepthCompareOpEXT = std::bit_cast<PFN_vkCmdSetDepthCompareOpEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetDepthCompareOpEXT"));
        vkCmdSetDepthTestEnableEXT = std::bit_cast<PFN_vkCmdSetDepthTestEnableEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetDepthTestEnableEXT"));
        vkCmdSetDepthWriteEnableEXT = std::bit_cast<PFN_vkCmdSetDepthWriteEnableEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetDepthWriteEnableEXT"));
        vkCmdSetFrontFaceEXT = std::bit_cast<PFN_vkCmdSetFrontFaceEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetFrontFaceEXT"));
        vkCmdSetPolygonModeEXT = std::bit_cast<PFN_vkCmdSetPolygonModeEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetPolygonModeEXT"));
        vkCmdSetPrimitiveRestartEnableEXT = std::bit_cast<PFN_vkCmdSetPrimitiveRestartEnableEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetPrimitiveRestartEnableEXT"));
        vkCmdSetPrimitiveTopologyEXT = std::bit_cast<PFN_vkCmdSetPrimitiveTopologyEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetPrimitiveTopologyEXT"));
        vkCmdSetRasterizationSamplesEXT = std::bit_cast<PFN_vkCmdSetRasterizationSamplesEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetRasterizationSamplesEXT"));
        vkCmdSetRasterizerDiscardEnableEXT = std::bit_cast<PFN_vkCmdSetRasterizerDiscardEnableEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetRasterizerDiscardEnableEXT"));
        vkCmdSetSampleMaskEXT = std::bit_cast<PFN_vkCmdSetSampleMaskEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetSampleMaskEXT"));
        vkCmdSetScissorWithCountEXT = std::bit_cast<PFN_vkCmdSetScissorWithCountEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetScissorWithCountEXT"));
        vkCmdSetStencilTestEnableEXT = std::bit_cast<PFN_vkCmdSetStencilTestEnableEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetStencilTestEnableEXT"));
        vkCmdSetViewportWithCountEXT = std::bit_cast<PFN_vkCmdSetViewportWithCountEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetViewportWithCountEXT"));

        vkCmdSetVertexInputEXT = std::bit_cast<PFN_vkCmdSetVertexInputEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdSetVertexInputEXT"));
        vkCmdBindShadersEXT = std::bit_cast<PFN_vkCmdBindShadersEXT>(vkGetDeviceProcAddr(Device()->VkDevice(), "vkCmdBindShadersEXT"));
        return 0;
    }

    BALBINO_NODISCARD_SINCE_CXX17 auto BeginCommand() const BALBINO_NOEXCEPT_SINCE_CXX11 -> int32_t
    {
    ...
    BALBINO_NODISCARD_SINCE_CXX17 auto EndCommand() const BALBINO_NOEXCEPT_SINCE_CXX11 -> int32_t
    {
    ...
    void SetViewport(const float xPos, const float yPos, const float width, const float height, const float minDepth = 0.0F, const float maxDepth = 1.0F) const BALBINO_NOEXCEPT_SINCE_CXX11
    {
    ...
    auto Handle() const BALBINO_NOEXCEPT_SINCE_CXX11 -> const VkCommandBuffer&
    {
