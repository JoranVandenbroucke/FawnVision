...
struct SPhysicalDeviceInfo final
{
    ...
    [[nodiscard]] auto GetMaxUsableSampleCount() const noexcept -> VkSampleCountFlagBits
    {
...
public:
    ...
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX14 auto Initialize(SPhysicalDeviceInfo deviceInfo, const std::vector<const char*>& layersToEnable, const std::vector<const char*>& extensionsToEnable) -> int32_t
    {
    ...
    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX14 auto VkDevice() const BALBINO_NOEXCEPT_SINCE_CXX11 -> const VkDevice&
    {
        return m_device;
    }

    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX14 auto PhysicalDeviceInfo() const BALBINO_NOEXCEPT_SINCE_CXX11 -> const SPhysicalDeviceInfo&
    {
        return m_deviceInfo;
    }

    BALBINO_NODISCARD_SINCE_CXX17 BALBINO_CONSTEXPR_SINCE_CXX14 auto DescriptorPool() const BALBINO_NOEXCEPT_SINCE_CXX11 -> VkDescriptorPool
    {
